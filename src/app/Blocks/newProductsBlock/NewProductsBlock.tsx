...
const NewProductsBlock = () => {
  ...
  return (
    <div className='NewProductsBlock'>
        ...
        {showMore?
        <div className={`NewProductsBlock_container `}>
        <div className={`NewProductsBlock_container_background ${filtersOpen? "background_active" : ""}`}></div>
        <Card price={"60.0"} name='Гладь с рисунком «горох»' article='1911-2'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «ромбы»' article='1911-3'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «диагональ»' article='1911-4'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «горох»' article='1915'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «горох»' article='1911-2'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «ромбы»' article='1911-3'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «диагональ»' article='1911-4'></Card>
        <Card price={"60.0"} name='Гладь с рисунком «горох»' article='1915'></Card>
